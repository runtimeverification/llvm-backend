...
llvm::Value *allocateBlock(llvm::Type *AllocType, llvm::BasicBlock *block, const char *name = "koreAlloc");
llvm::Value *allocateBlock(llvm::Type *AllocType, llvm::Value *Len, llvm::BasicBlock *block, const char *name = "koreAlloc");
}
