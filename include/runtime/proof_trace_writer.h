...
public:
  ...
  virtual void tail_call_info(char const *caller_name, char const *callee_name, bool is_tail) = 0;
...
public:
  ...
  void tail_call_info(char const *caller_name, char const *callee_name, bool is_tail) override {
    write_uint64(kllvm::tail_call_info_sentinel);
    write_null_terminated_string(caller_name);
    write_null_terminated_string(callee_name);
    write_bool(is_tail);
  }
