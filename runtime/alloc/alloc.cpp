...
__attribute__ ((always_inline)) block *koreAllocToken_p1s_blocks(size_t requested) {
...
__attribute__ ((always_inline)) map *koreAllocAlwaysGC_p1s_maps(size_t requested) {
  return (map *)koreAllocAlwaysGC(requested);
}

__attribute__ ((always_inline)) set *koreAllocAlwaysGC_p1s_sets(size_t requested) {
  return (set *)koreAllocAlwaysGC(requested);
}

__attribute__ ((always_inline)) list *koreAllocAlwaysGC_p1s_lists(size_t requested) {
  return (list *)koreAllocAlwaysGC(requested);
}

__attribute__ ((always_inline)) block *koreAllocAlwaysGC_p1s_blocks(size_t requested) {
...
__attribute__ ((always_inline)) mpz_ptr koreAllocInteger_p1s_mpzs(size_t requested) {
...
__attribute__ ((always_inline)) floating *koreAllocFloating_p1s_floatings(size_t requested) {
