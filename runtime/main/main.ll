...
declare i8* @koreAllocNoGC(i64)
declare i8* @koreReallocNoGC(i8*, i64, i64)
...
entry:
  ...
  call void @__gmp_set_memory_functions(i8* (i64) * @koreAllocNoGC, i8* (i8*, i64, i64) * @koreReallocNoGC, void (i8*, i64) * @koreFree)
