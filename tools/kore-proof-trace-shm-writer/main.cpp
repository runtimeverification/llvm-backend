...
cl::OptionCategory kore_proof_trace_shm_writer_cat("kore-proof-trace-shm-writer options");
...
cl::opt<std::string> shm_filename(
    cl::Positional, cl::desc("<shared memory file>"),
    cl::Required, cl::cat(kore_proof_trace_shm_writer_cat));
